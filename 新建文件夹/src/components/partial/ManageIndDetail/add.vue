...
<script>
  ...
  export default {
    ...
    data () {
      return {
        Draggable: '',
        base: [{'display_text': '指标名称', 'col_type': '文本', 'col_width': '适中', 'is_notnull': '是', 'is_multi_org': '是', 'edit': false}, {'display_text': '归属学校', 'col_type': '文本', 'col_width': '适中', 'is_notnull': '是', 'is_multi_org': '是', 'edit': false}, {'display_text': '数据年份', 'col_type': '日期（年）', 'col_width': '', 'is_notnull': '是', 'is_multi_org': '是', 'edit': false}],
        isLoading: false,
        options: [],
        itemVal: {},
        changeIndex: 1,
