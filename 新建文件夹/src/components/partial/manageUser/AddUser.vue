<template>
  <Form
    ...
    <FormItem label="学校" prop="org" v-if="user.role.type_id === 3">
      <Select v-model="user.org" placeholder="请选择归属学校" size="medium" class="role-select" value-key="id">
        <Option
   ...
   <!-- <FormItem label="院系" prop="org" v-if="user.role.type_id === 4">
    ...
    <FormItem label="部门" prop="department">
      <Input type="text" v-model="user.department" size="medium" placeholder="请输入部门信息" />
    </FormItem>
    <FormItem label="电话" prop="tel">
      <Input type="text" v-model="user.tel" size="medium" placeholder="请输入电话号码" />
    </FormItem>
    ...
    data () {
      return {
        ...
        rules: {
          ...
          email: [
            { required: true, type: 'email', message: '请输入正确的电子邮箱', trigger: 'blur' }
          ],
          remark: [
