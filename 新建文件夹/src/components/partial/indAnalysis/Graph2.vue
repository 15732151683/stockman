            ...
            markLine: {
              ...
              label: {
                normal: {
                  ...
                  position: 'end',
                  formatter (params) {
                    return _self.$t('outIn.text') + (params.value > 1 ? (isPercent ? (params.value.toFixed(0) * 100) + '%' : params.value.toFixed(0)) : (params.value > 0.1 ? (isPercent ? (params.value.toFixed(1) * 100) + '%' : params.value.toFixed(1)) : (isPercent ? (params.value.toFixed(2) * 100) + '%' : params.value.toFixed(2))))
                  }
                }
              },
              symbol: 'image://',
