    ...
    <Dialog
      ...
      <div class="detail-dialog">
        <div class="detail-title">
          <span>{{this.currentData.year}}&nbsp;&nbsp;{{this.currentInd.name}}明细</span>
        </div>
        ...
        <div class="detail-table ind-table inner-table" v-if="detailTemplate && detailTemplate.length > 0">
          <Table :data="allDetail" style="width: 100%" :row-class-name="tableRowClassName">
            <TableColumn label="院系" align="left" width="180" prop="org_name">
            </TableColumn>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions('write', ['getAllYearDetail', 'getDetailTemplate', 'updateIndDetail', 'deleteDetail', 'changeDetail']),
      ...
      confirmEditDetail () {
        this.$refs.formEditDetail.validate((valid) => {
          if (valid) {
            ...
            let payload = {
              indId: this.detailData.ind_data_id,
