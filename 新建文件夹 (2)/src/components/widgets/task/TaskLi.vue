<template>
  <li :class="['task-li', 'task-li-' + item.task_node.status_type, {'task-li-active': currentTask.id === item.id}]" @click="handleDetail">
    <TaskList :task="item" :taskNodes="taskNodes" :listStyle="listStyle">
      <div slot="aside">
        <template>
